...
Each hallway string will contain three different types of characters: 
    '>', an employee walking to the right; '<', an employee walking to the left; and '-', an empty space. 
...
returns the number of times the employees will salute and will contain at least 1 and at most 100 characters,
each one of -, >, or <.'''
