...
representing the bumps and absence of bumps in the input string. Your function should be able to 
encode the 26 lowercase letters, handle capital letters by adding a Braille capitalization mark before that character, 
and use a blank character (000000) for spaces. All signs on the space station are less than fifty 
...
braille_dict = {'a':'100000', 'b':'110000', 'c':'100100', 'd':'100110', 'e':'100010', 
           ...
           'z':'101011', ' ':'000000', 'cap':'000001'}

def convert_to_braille(txt):
    textList = []
    final = ''
    for i in txt:
        if i.isupper():
